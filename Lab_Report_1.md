...
you will be able to work from various locations while accessing files from another account.</br>
## The CSE15L Account
...
To find your account go to link: https://sdacs.ucsd.edu/~icc/index.php and log in using your UCSD account username, and PID. </br> </br>
Once you have logged in, you are prompted with this page, and once here click on the cs15lwi23XXX </br>
<img width="552" alt="image" src="https://user-images.githubusercontent.com/108485221/212535867-0f185645-7dd8-492b-993f-97276ddac485.png"></br> </br>
...
after typing in the confirm your password instead. </br>
<img width="552" alt="image" src="https://user-images.githubusercontent.com/108485221/212536145-3d4f4ab8-9ef4-4fbe-8466-447d1c31b13c.png"> </br>
...
will not take affect immediately, and will take some time before it goes into effect. So wait about 15-60 minutes before trying to log in. </br>
## Visual Studio Code
...
<img width="552" alt="Screen Shot 2023-01-15 at 2 57 51 AM" src="https://user-images.githubusercontent.com/108485221/212536732-518d402e-b125-4be8-b633-10215d6214be.png"> </br>
Once you have downloaded the VS code, open up the zip file you have downloaded, and let that download VS code onto your machine.</br>
<img width="552" alt="image" src="https://user-images.githubusercontent.com/108485221/212536850-20a6786e-f132-4799-8028-c58dcba53a1b.png"> </br>
Once all of this has been done, you should be able to open up VS code and now you have successfully installed an IDE by the name of Visual Studio Code.</br>
...
we will need to install that. To install use this link: https://gitforwindows.org/ and once installed open a new terminal in VS Code. </br>
<img width="552" alt="image" src="https://user-images.githubusercontent.com/108485221/212537281-ca8dfa2d-3285-4cdf-a283-5bc036e7e331.png"> </br>
...
it is there, it is just not showing it*). </br>
<img width="552" alt="image" src="https://user-images.githubusercontent.com/108485221/212537680-5e6db52d-6f5d-4cb1-bbb8-39c53a4a5028.png"> </br>
...
your remote account.
## Trying Commands
There are many commands that you can do while in here. </br>
### From: 
* ls
* cd
* ls -a
...
another file. And cat is just to essentially print out whatever is present in the file into the terminal. </br>
<img width="552" alt="image" src="https://user-images.githubusercontent.com/108485221/212538363-db19c859-864b-4ae4-9c17-8a4df482f1d4.png"> </br>
## Closing Thoughts
